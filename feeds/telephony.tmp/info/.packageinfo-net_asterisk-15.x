...
Category: Network
Repository: base
Title: Complete open source PBX, v15.6.1
Maintainer: Jiri Slachta <jiri@slachta.eu>
Source: asterisk-15.6.1.tar.gz
License: GPL-2.0
...
Submenu: Telephony
Version: 15.6.1-1
Depends: +libc +GCC_LIBSSP:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk15 +BUILD_NLS:libiconv-full
Conflicts: 
Menu-Depends: 
Provides: 
Section: net
